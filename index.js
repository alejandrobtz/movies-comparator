...
const onMovieSelect = async (movie, summaryElement, side) => {
    ...
    if(leftMovie && rightMovie){
        console.log("shouldruncomparison"); 
        runComparison(); 
    }
...
const runComparison = () => {
    ...
    leftSideStats.forEach((leftStat, index) => {
        ...
        console.log(rightSideValue > leftSideValue, rightSideValue, leftSideValue); 
        ...
        <article class="media">
            ...
            <div class="media-content">
                <div class="content">
                    ...
                    <p>
                        <b>Writer:</b> <i>${movieDetail.Writer}</i>, 
                        <b>Director:</b> <i>${movieDetail.Director}</i>
                    </p>
                </div>
            </div>
        </article>
